...
class AEWeb
{
	...
	public function GET_ContabilidadDescargamasivaNotificar(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/contabilidad/descargamasiva/<id>/notificar"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
