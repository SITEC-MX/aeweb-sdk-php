...
class AEWeb
{
	...
	public function GET_RutaRutasCartasporte(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/ruta/rutas/<id>/cartasporte"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
