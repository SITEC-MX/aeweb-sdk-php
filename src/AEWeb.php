...
class AEWeb
{
    ...
    public function API_CALL(string $metodo, string $url, ?array $variables=NULL, ?array $querystrings=NULL, ?array $body=NULL)
    {
        ...
        {
            $estado = array("estado"=>AEWeb::ENDPOINT_ERROR_GENERAR, "mensaje"=>"Error al generar la URL de la llamada.", "debug"=> $t->getMessage());
        }
	...
	public function GET_EmpresaReportesconduccion(?array $variables=NULL,?array $querystrings=NULL){ $url = NULL; $variables_key = $this->ObtenerFirmaDeVariables($variables); switch($variables_key) { case "empresa": $url = "<empresa>/empresa/reportesconduccion"; break; case "empresa-id": $url = "<empresa>/empresa/reportesconduccion/<id>"; break; case "aleatorio-empresa-id": $url = "<empresa>/empresa/reportesconduccion/<id>/<aleatorio>"; break;  default: $url = "<empresa>/empresa/reportesconduccion/<id>/<aleatorio>"; break; } return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function POST_EmpresaReportesconduccionQuery(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/empresa/reportesconduccion/query"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	...
	public function GET_TiendaUsuarios(?array $variables=NULL,?array $querystrings=NULL){ $url = NULL; $variables_key = $this->ObtenerFirmaDeVariables($variables); switch($variables_key) { case "empresa": $url = "<empresa>/tienda/usuarios"; break; case "empresa-id": $url = "<empresa>/tienda/usuarios/<id>"; break;  default: $url = "<empresa>/tienda/usuarios/<id>"; break; } return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function POST_TiendaUsuarios(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/tienda/usuarios"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function PATCH_TiendaUsuarios(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/tienda/usuarios/<id>"; return $this->API_CALL("PATCH", $url, $variables, $querystrings, $body); }
	public function DELETE_TiendaUsuarios(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/tienda/usuarios/<id>"; return $this->API_CALL("DELETE", $url, $variables, $querystrings, NULL); }
	public function GET_TiendaDocumentos(?array $variables=NULL,?array $querystrings=NULL){ $url = NULL; $variables_key = $this->ObtenerFirmaDeVariables($variables); switch($variables_key) { case "empresa": $url = "<empresa>/tienda/documentos"; break; case "empresa-id": $url = "<empresa>/tienda/documentos/<id>"; break;  default: $url = "<empresa>/tienda/documentos/<id>"; break; } return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function POST_TiendaDocumentos(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/tienda/documentos"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function PATCH_TiendaDocumentos(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/tienda/documentos/<id>"; return $this->API_CALL("PATCH", $url, $variables, $querystrings, $body); }
	public function POST_TiendaSesionLogin(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/tienda/sesion/login"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function POST_TiendaSesionLogout(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/tienda/sesion/logout"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function GET_TiendaPerfil(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/tienda/perfil"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function POST_TiendaPresentaciones(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/tienda/presentaciones"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	...
	public function POST_SesionCambiarContrasena(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/sesion/cambiar-contrasena"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function PATCH_PerfilFotografia(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/perfil/fotografia"; return $this->API_CALL("PATCH", $url, $variables, $querystrings, $body); }
	public function GET_PerfilHistorial(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/perfil/historial"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	...
	public function GET_DocumentosTraspasosporaceptar(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/documentos/traspasosporaceptar"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function GET_DocumentosComprasporasociar(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/documentos/comprasporasociar"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function GET_DocumentosSurtibles(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/documentos/surtibles"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	...
	public function POST_DocumentosAceptar_traspaso(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/documentos/<id>/aceptar_traspaso"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function POST_DocumentosVincular_facturarecibida(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/documentos/<id>/vincular_facturarecibida"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function POST_DocumentosDuplicar(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/documentos/<id>/duplicar"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	...
	public function POST_DocumentosCobro_url(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/documentos/<id>/<aleatorio>/cobro_url"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function GET_DocumentosOpenpay(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/documentos/<id>/<aleatorio>/openpay/<openpay_id>"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	...
	public function GET_MovimientoTiposdocumentoDuplicables(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/movimiento/tiposdocumento/duplicables"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	...
	public function GET_MovimientoTiposdocumentoRequisitos(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/movimiento/tiposdocumento/<id>/requisitos"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function GET_MovimientoFormatosdocumento(?array $variables=NULL,?array $querystrings=NULL){ $url = NULL; $variables_key = $this->ObtenerFirmaDeVariables($variables); switch($variables_key) { case "empresa": $url = "<empresa>/movimiento/formatosdocumento"; break; case "empresa-id": $url = "<empresa>/movimiento/formatosdocumento/<id>"; break;  default: $url = "<empresa>/movimiento/formatosdocumento/<id>"; break; } return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function POST_MovimientoFormatosdocumento(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/movimiento/formatosdocumento"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function PATCH_MovimientoFormatosdocumento(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/movimiento/formatosdocumento/<id>"; return $this->API_CALL("PATCH", $url, $variables, $querystrings, $body); }
	public function DELETE_MovimientoFormatosdocumento(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/movimiento/formatosdocumento/<id>"; return $this->API_CALL("DELETE", $url, $variables, $querystrings, NULL); }
	...
	public function POST_TpvDocumentos(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/tpv/documentos"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function POST_AppLogin(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/app/login"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	...
	public function GET_AewebApikeys(?array $variables=NULL,?array $querystrings=NULL){ $url = NULL; $variables_key = $this->ObtenerFirmaDeVariables($variables); switch($variables_key) { case "empresa": $url = "<empresa>/aeweb/apikeys"; break; case "empresa-id": $url = "<empresa>/aeweb/apikeys/<id>"; break;  default: $url = "<empresa>/aeweb/apikeys/<id>"; break; } return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function POST_AewebApikeys(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/aeweb/apikeys"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
	public function PATCH_AewebApikeys(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/aeweb/apikeys/<id>"; return $this->API_CALL("PATCH", $url, $variables, $querystrings, $body); }
	public function DELETE_AewebApikeys(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/aeweb/apikeys/<id>"; return $this->API_CALL("DELETE", $url, $variables, $querystrings, NULL); }
	public function POST_AewebApikeysRenovar(?array $variables=NULL,?array $querystrings=NULL,?array $body=NULL){ $url = "<empresa>/aeweb/apikeys/<id>/renovar"; return $this->API_CALL("POST", $url, $variables, $querystrings, $body); }
