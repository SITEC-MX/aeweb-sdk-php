...
class AEWeb
{
	...
	public function GET_DocumentoAleatorio(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/documento/<rfc>/<folio>/aleatorio"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function GET_Documento(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/documento/<id>/<aleatorio>"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function GET_DocumentoDetalles(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/documento/<id>/<aleatorio>/detalles"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
	public function GET_DocumentoArchivos(?array $variables=NULL,?array $querystrings=NULL){ $url = "<empresa>/documento/<id>/<aleatorio>/archivos"; return $this->API_CALL("GET", $url, $variables, $querystrings, NULL); }
